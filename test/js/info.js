...
{
    var data = JSON.parse(localStorage.movie_data);
    //console.log(data);
...
function DisplayMovieInfo(data,images)
{
        ...
        HTMLDom += "<div class='info_wrapper_top'>";
            HTMLDom += "<div class='info_wrapper_centered'>";
                ...
                HTMLDom += "<div class='info_wrapper_one'>";
                    ...
                    HTMLDom += "</div>"
                    HTMLDom += "<div class='json_data'>";
                    for(var x = 0; x < data.spoken_languages.length;x++)
                        {
    ...
    HTMLDom += "<div class='info_wrapper_bottom'>";
        ...
        HTMLDom += "</div>";
        HTMLDom += "<div class='movie_budget'>";
            HTMLDom += "<a>Proračun: </a>";
            HTMLDom += "<a class='movie_budget_data'>" + kFormatter(data.budget) + " $ </a></br>";
            HTMLDom += "<a>Prihodki: </a>";
            HTMLDom += "<a class='movie_revenue_data'>" + kFormatter(data.revenue) + " $ </a></br>";
        HTMLDom += "</div>";
        HTMLDom += "<div class='movie_production_houses'>";
            HTMLDom += "<a>Produkcijske hiše: </a>";
            HTMLDom += "<a class='movie_production_house_data'>";
            for(var i = 0; i < data.production_companies.length;i++)
                {
                    if(i != data.production_companies.length - 1)
                        {
                            HTMLDom += data.production_companies[i].name + ", ";
                        }
                    else
                        HTMLDom += data.production_companies[i].name + "</a>";
                }
        HTMLDom += "</div>";
